    ...
    def handle(self) -> None:
        ...
        while True:
            ...
            if not msg:
                ...
                break
            print(
                f"客户端(ip: {client_ip}, port: {client_port}) 发来消息:",
                msg.decode("utf-8"),
            )
...
with socketserver.ThreadingTCPServer(("localhost", 12345), ServiceHandler) as server:
    print("server is listening...")
    # 开启无限循环，监听连接
    server.serve_forever()
    # 在with context里面, 不需要关闭监听 server.shutdown()
