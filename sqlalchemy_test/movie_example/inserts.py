...
def main():
    ...
    vm1 = VM(vmid=str(uuid4()), vmname="vm1")
    vm2 = VM(vmid=str(uuid4()), vmname="vm2")
    vm3 = VM(vmid=str(uuid4()), vmname="vm3")
    vm4 = VM(vmid=str(uuid4()), vmname="vm4")
